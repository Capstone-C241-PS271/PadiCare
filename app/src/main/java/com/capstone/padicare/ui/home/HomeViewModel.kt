...
class HomeViewModel(private val userRepository: UserRepository) : ViewModel() {
    ...
    private val _userInfo = MutableLiveData<ResultState<UserModel>>()
    val userInfo: LiveData<ResultState<UserModel>> = _userInfo

    fun fetchUserInfo(token: String): LiveData<ResultState<UserModel>> {
